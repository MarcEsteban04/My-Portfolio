...
function TimelineItem({ title, company, period, description, achievements, isLeft = false, icon, color }: TimelineItemProps) {
...
export function EnhancedAboutSection() {
  ...
  const funFacts = [
    { icon: <Clock />, value: '3+', label: 'Years Coding', color: 'from-blue-500/60 to-blue-600/60' },
    { icon: <Code />, value: '4+', label: 'Projects Built', color: 'from-green-500/60 to-green-600/60' },
            ...
            <div className="flex flex-col md:flex-row items-center gap-8">
              <div className="flex-1 space-y-6">
                ...
                <div className="flex flex-wrap gap-4">
                  <div className="flex items-center gap-2 px-3 py-2 bg-gradient-to-r from-green-500/20 to-emerald-500/20 rounded-full border border-green-500/30">
